...
from models import  CembEmbed, CembRNN, DembEmbed, DembRNN, DembFtEmbed, DembFtRNN
...
EMBED_MODELS = {
    'code_emb': CembEmbed,
    'desc_emb': DembEmbed,
    'desc_emb_ft': DembFtEmbed,
}
PREDICT_MODELS = {
    'code_emb': CembRNN,
    'desc_emb': DembRNN,
    'desc_emb_ft': DembFtRNN,
}
...
class EHRModel(nn.Module):
    def __init__(self, args):
        ...
        self.embed_model = EMBED_MODELS[args.embed_model_type](self.args)
        self.pred_model = PREDICT_MODELS[args.predict_model_type](self.args)
...
#         net_output = self.pred_model(x, **kwargs)
        ...
        # Replace the inputs with the input embeddings.
        kwargs['x'] = x
        kwargs['rev_x'] = rev_x
